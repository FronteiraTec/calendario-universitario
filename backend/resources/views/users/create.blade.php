                        ...
                        <form method="post" action="{{ route('user.store') }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="email" name="email" id="input-email" class="form-control form-control-alternative{{ $errors->has('email') ? ' is-invalid' : '' }}" placeholder="E-mail" value="{{ old('email') }}" required>
                                ...
                                <div class="form-group{{ $errors->has('password') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="password" name="password" id="input-password" class="form-control form-control-alternative{{ $errors->has('password') ? ' is-invalid' : '' }}" placeholder="Senha" value="" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" name="password_confirmation" id="input-password-confirmation" class="form-control form-control-alternative" placeholder="Confirmar senha" value="" required>
                                </div>
