                    ...
                    <div class="card-body">
                        ...
                        <div class="pl-lg-4">
                            <div class="form-group{{ $errors->has('day') ? ' has-danger' : '' }}">
                                ...
                                <input disabled type="date" name="day" id="input-day" class="form-control form-control-alternative{{ $errors->has('day') ? ' is-invalid' : '' }}" placeholder="Data" value="{{ old('day', $meal->day) }}" required autofocus>
                            </div>
